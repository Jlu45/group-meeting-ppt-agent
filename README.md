...
|---------|-------|-------------|
| [ppt-master](https://github.com/hugohe3/ppt-master) | 10.6k | Template DNA extraction, SVG→native PPTX |
| [MarkItDown](https://github.com/microsoft/markitdown) | 82.6k | Universal document → Markdown conversion |
| [Docling](https://github.com/docling-project/docling) | 42.6k | Complex PDF deep parsing |
